...
public class HelloServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<grpc.example.HelloRequest,
      grpc.example.HelloResponse> METHOD_SAY_HELLO =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "service.HelloService", "SayHello"),
          io.grpc.protobuf.ProtoUtils.marshaller(grpc.example.HelloRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(grpc.example.HelloResponse.getDefaultInstance()));
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(grpc.example.HelloRequest request,
        io.grpc.stub.StreamObserver<grpc.example.HelloResponse> responseObserver) {
    ...
    @Override public io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                grpc.example.HelloRequest,
                grpc.example.HelloResponse>(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public grpc.example.HelloResponse sayHello(grpc.example.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.example.HelloResponse> sayHello(
        grpc.example.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((grpc.example.HelloRequest) request,
              (io.grpc.stub.StreamObserver<grpc.example.HelloResponse>) responseObserver);
          break;
        default:
