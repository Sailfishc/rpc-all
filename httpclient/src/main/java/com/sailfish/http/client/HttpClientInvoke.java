package com.sailfish.http.client;


import com.alibaba.fastjson.JSON;
import com.sailfish.http.ApiResponse;
import com.sailfish.http.HttpInvokeCallable;
...
public class HttpClientInvoke {
    ...
    public void test1() throws Exception {
        ...
        nvps.add(new BasicNameValuePair("userName", "sailfish"));
    ...
    public void testHttpGet() throws Exception {
        ...
        URI uri = new URIBuilder()
                ...
                .setParameter("userName", "sailfish")
                .build();
    ...
    public void testFluentApi_2() throws IOException {
        ...
        String uri = "http://localhost:8080/hello/sayHello.json?userName=sailfish";
    ...
    public void testFutureRequest() throws Exception {
        ...
        String url = "http://localhost:8080/hello/sayHello.json?userName=sailfish";
